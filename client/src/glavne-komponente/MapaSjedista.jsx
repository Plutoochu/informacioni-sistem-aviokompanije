...
// TODO (Backend): OVDJE SU PRIVREMENI PODACI (mock) - treba ih zamijeniti pravim API pozivom
  ...
  const renderSeatMap = () => {
    ...
    // Prva klasa 
    seats.push(<div key="first-label" className="class-label">Prva klasa</div>);
    ...
    // Biznis klasa 
    seats.push(<div key="business-label" className="class-label">Biznis klasa</div>);
    ...
    // Ekonomska klasa 
    seats.push(<div key="economy-label" className="class-label">Ekonomska klasa</div>);
...
// - Vratiti grešku (409 Conflict) ako bilo koje sjedište više nije dostupno
  ...
  return (
    <div className="seat-map-container">
      ...
      <p>
        <strong>Putnika:</strong> {totalPassengers} | 
        <strong>Klasa:</strong> {reservation.classType}
      </p>
